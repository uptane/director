...
object GroupName {
  ...
  implicit val validatedGroupName: com.advancedtelematic.libats.data.ValidatedGeneric[com.advancedtelematic.ota.deviceregistry.data.GroupName,String] = new ValidatedGeneric[GroupName, String] {
