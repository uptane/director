...
//    RouteTestTimeout(10.second)
  ...
  implicit lazy val routes: Route = new DirectorRoutes(keyserverClient, allowEcuReplacement = true).routes ~
...
//  implicit lazy val routes: Route = routes2
}
