...
object TagId {
  ...
  implicit val validatedTagId: com.advancedtelematic.libats.data.ValidatedGeneric[com.advancedtelematic.deviceregistry.data.TagId,String] = new ValidatedGeneric[TagId, String] {
