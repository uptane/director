...
import com.advancedtelematic.deviceregistry.data.{DeviceSortBy, GroupSortBy, SortDirection}
...
import com.advancedtelematic.deviceregistry.db.GroupInfoRepository.GroupInfoTable
